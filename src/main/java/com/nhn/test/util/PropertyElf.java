...
public class PropertyElf {
    ...
    public static void setTargetFromProperties(final Object target, final Properties properties) {
        ...
        properties.forEach((key, value) -> {
            if (target instanceof TestConfig && key.toString().startsWith("dataSource.")) {
                ((TestConfig) target).addDataSourceProperty(key.toString().substring("dataSource.".length()), value);
            }
            else {
